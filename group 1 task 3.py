...
def main():
    ...
    if show_animation:  # pragma: no cover
        ...
        plt.plot(aac_x, aac_y, "Xg")
        plt.plot(bbc_x, bbc_y, "Xg")
        plt.plot(ccc_x, ccc_y, "Xg")
        plt.plot(ddc_x, ddc_y, "Xg")
        plt.plot(eec_x, eec_y, "Xg")
        plt.plot(ffc_x, ffc_y, "Xg")
        plt.plot(ggc_x, ggc_y, "Xg")
        plt.plot(hhc_x, hhc_y, "Xg")
        plt.plot(iic_x, iic_y, "Xg")
        plt.plot(jjc_x, jjc_y, "Xg")
        plt.plot(kkc_x, kkc_y, "Xg")
        plt.plot(llc_x, llc_y, "Xg")
        plt.plot(mmc_x, mmc_y, "Xg")
        plt.plot(nnc_x, nnc_y, "Xg")
        plt.plot(ooc_x, ooc_y, "Xg")
