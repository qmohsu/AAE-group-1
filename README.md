...
#### Tsang Shing Chi (21091151d)

In this project, I am mainly responsible for team coordination, editing of the final video and multiple other tasks. While team coordination itself is rather challenging, doing so under hybrid mode and language barrier make the challenge even greater, but overcoming these challenges allowed me to learn much from this project. During this project, I also learned the basics of a pathfinding algorithm along with Python, a coding language, both of them being versatile tools that will also be useful in the future.
Other teammates in the group also encountered different challenges when tackling their assigned parts, and the importance of time management also become apparent during the later stage of this project. In conclusion, I would say that while this project has been quite stressful given my lack of knowledge concerning coding beforehand and my role as the coordinator, but I too have gained valuable experience when carrying out my duties, and will have plenty of oppotunities to apply them in foreseeable future.
### Reference
